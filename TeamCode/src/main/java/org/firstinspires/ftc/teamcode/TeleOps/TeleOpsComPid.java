...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "TeleOperado com pid teste", group = "OpMode")
public class TeleOpsComPid extends OpMode {
    ...
    public void arm() {
        ...
        if (gamepad2.right_bumper) {
            braço.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            braço.setPower(1);
            posAlvo = braço.getCurrentPosition();
    ...
    double currvel;
    double lastError;
    //pid constantes braço


    public double pidLinear(double velocidade) {


        currvel = braço.getVelocity();
        ...
        double ff;
        double output = (error * kp_arm + derivate * kd_arm + integral * ki_arm);
        return output;
