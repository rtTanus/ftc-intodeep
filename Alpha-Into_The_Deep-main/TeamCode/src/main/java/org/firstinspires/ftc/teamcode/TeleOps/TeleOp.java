...
public class TeleOp extends OpMode {
    DcMotor MET, MEF, MDT, MDF, LSi, LSii, braço, roboAng; //Define os motores no sistema
    ...
    Elevator linear = new Elevator(hardwareMap.get(DcMotorEx.class, "LSi"),
            hardwareMap.get(DcMotorEx.class, "LSii"));
